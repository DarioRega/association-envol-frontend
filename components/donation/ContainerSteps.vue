<template>
  <section class="w-full bg-white rounded-md shadow-md">
    <div
      class="rounded-t-md bg-brand-dark-blue py-4 sm:py-6 md:py-8 flex items-center justify-center px-5 lg:px-12"
    >
    ...
    <div
      class="p-5 md:px-10 lg:px-16 2xl:px-20 form-container flex flex-col items-center justify-center"
    >
      <slot name="form" />
    </div>
    <slot name="stepper" />
